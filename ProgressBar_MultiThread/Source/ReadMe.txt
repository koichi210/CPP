================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: MultiThread_ProgressBar プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した MultiThread_ProgressBar には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには MultiThread_ProgressBar アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

MultiThread_ProgressBar.vcxproj
...
MultiThread_ProgressBar.vcxproj.filters
...
MultiThread_ProgressBar.h
   これはアプリケーションのメイン ヘッダー ファイルです。このファイルには、
   Resource.h を含む、その他のプロジェクト固有のヘッダーが含まれていて、
   CProgressBarApp アプリケーション クラスを宣言します。

MultiThread_ProgressBar.cpp
   これは、アプリケーション クラス CProgressBarApp を含むメイン アプリケー
   ション ソース ファイルです。

MultiThread_ProgressBar.rc
...
res\MultiThread_ProgressBar.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル MultiThread_ProgressBar.rc に含まれていま
   す。

res\MultiThread_ProgressBar.rc2
...
MultiThread_ProgressBarDlg.h, MultiThread_ProgressBarDlg.cpp - ダイアログ
   これらのファイルは CProgressBarDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な MultiThread_ProgressBar.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   MultiThread_ProgressBar.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
...
MultiThread_ProgressBar.manifest
