========================================================================
    Win32 アプリケーション: BinaryEdit_Win32 プロジェクトの概要
========================================================================

この BinaryEdit_Win32 アプリケーションは、AppWizard により作成されました。

このファイルには、BinaryEdit_Win32 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


BinaryEdit_Win32.vcxproj
...
BinaryEdit_Win32.vcxproj.filters
...
BinaryEdit_Win32.ico
    これは、アプリケーションのアイコン (32x32) として使用されるアイコン 
    ファイルです。
    このアイコンは、メイン リソース ファイル BinaryEdit_Win32.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル BinaryEdit_Win32.rc 
    にインクルードされます。
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、BinaryEdit_Win32.pch 
