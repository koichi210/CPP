================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: MultiThread プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した MultiThread には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには MultiThread アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
MultiThread.h
   ...
   CMultiThreadApp アプリケーション クラスを宣言します。

MultiThread.cpp
   これは、アプリケーション クラス CMultiThreadApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\MultiThread.ico
   ...
   アイコンはメイン リソース ファイル MultiThread.rc に含まれていま
   す。
...
MultiThreadDlg.h, MultiThreadDlg.cpp - ダイアログ
   これらのファイルは CMultiThreadDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な MultiThread.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   MultiThread.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
