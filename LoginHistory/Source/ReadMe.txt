================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: LoginHistory プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した LoginHistory には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには LoginHistory アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

LoginHistory.vcxproj
...
LoginHistory.h
   ...
   CLoginHistoryApp アプリケーション クラスを宣言します。

LoginHistory.cpp
   これは、アプリケーション クラス CLoginHistoryApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\LoginHistory.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル LoginHistory.rc に含まれていま
   す。

res\LoginHistory.rc2
...
LoginHistoryDlg.h, LoginHistoryDlg.cpp - ダイアログ
   これらのファイルは CLoginHistoryDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な LoginHistory.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   LoginHistory.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
