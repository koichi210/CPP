================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: memcpy プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した memcpy には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには memcpy アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
memcpy.h
   ...
   CmemcpyApp アプリケーション クラスを宣言します。

memcpy.cpp
   これは、アプリケーション クラス CmemcpyApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\memcpy.ico
   ...
   アイコンはメイン リソース ファイル memcpy.rc に含まれていま
   す。
...
memcpyDlg.h, memcpyDlg.cpp - ダイアログ
   これらのファイルは CmemcpyDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な memcpy.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   memcpy.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
