================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: BackUpDiff プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した BackUpDiff には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには BackUpDiff アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
BackUpDiff.h
   ...
   CBackUpDiffApp アプリケーション クラスを宣言します。

BackUpDiff.cpp
   これは、アプリケーション クラス CBackUpDiffApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\BackUpDiff.ico
   ...
   アイコンはメイン リソース ファイル BackUpDiff.rc に含まれていま
   す。
...
BackUpDiffDlg.h, BackUpDiffDlg.cpp - ダイアログ
   これらのファイルは CBackUpDiffDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な BackUpDiff.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   BackUpDiff.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
