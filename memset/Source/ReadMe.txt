================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: memset プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した memset には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには memset アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
memset.h
   ...
   CmemsetApp アプリケーション クラスを宣言します。

memset.cpp
   これは、アプリケーション クラス CmemsetApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\memset.ico
   ...
   アイコンはメイン リソース ファイル memset.rc に含まれていま
   す。
...
memsetDlg.h, memsetDlg.cpp - ダイアログ
   これらのファイルは CmemsetDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な memset.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   memset.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
