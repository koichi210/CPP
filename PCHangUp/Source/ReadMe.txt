================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: PCHangUp プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した PCHangUp には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには PCHangUp アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
PCHangUp.h
   ...
   CPCHangUpApp アプリケーション クラスを宣言します。

PCHangUp.cpp
   これは、アプリケーション クラス CPCHangUpApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\PCHangUp.ico
   ...
   アイコンはメイン リソース ファイル PCHangUp.rc に含まれていま
   す。
...
PCHangUpDlg.h, PCHangUpDlg.cpp - ダイアログ
   これらのファイルは CPCHangUpDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な PCHangUp.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   PCHangUp.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
