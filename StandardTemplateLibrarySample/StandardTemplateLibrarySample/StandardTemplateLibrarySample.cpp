...
// StandardTemplateLibrarySample.cpp : アプリケーションのクラス動作を定義します。
//
...
// CStandardTemplateLibrarySampleApp コンストラクション
...
// 唯一の CStandardTemplateLibrarySampleApp オブジェクトです。

CStandardTemplateLibrarySampleApp theApp;


// CStandardTemplateLibrarySampleApp 初期化
