================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: StandardTemplateLibrarySample プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した StandardTemplateLibrarySample には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには StandardTemplateLibrarySample アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

StandardTemplateLibrarySample.vcxproj
...
StandardTemplateLibrarySample.vcxproj.filters
...
StandardTemplateLibrarySample.h
   これはアプリケーションのメイン ヘッダー ファイルです。このファイルには、
   Resource.h を含む、その他のプロジェクト固有のヘッダーが含まれていて、
   CStandardTemplateLibrarySampleApp アプリケーション クラスを宣言します。

StandardTemplateLibrarySample.cpp
   これは、アプリケーション クラス CStandardTemplateLibrarySampleApp を含むメイン アプリケー
   ション ソース ファイルです。

StandardTemplateLibrarySample.rc
...
res\StandardTemplateLibrarySample.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル StandardTemplateLibrarySample.rc に含まれていま
   す。

res\StandardTemplateLibrarySample.rc2
...
StandardTemplateLibrarySampleDlg.h, StandardTemplateLibrarySampleDlg.cpp - ダイアログ
   これらのファイルは CStandardTemplateLibrarySampleDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な StandardTemplateLibrarySample.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   StandardTemplateLibrarySample.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
...
StandardTemplateLibrarySample.manifest
