================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: SignedUnsigned プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した SignedUnsigned には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには SignedUnsigned アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

SignedUnsigned.vcxproj
...
SignedUnsigned.vcxproj.filters
...
SignedUnsigned.h
   ...
   CSignedUnsignedApp アプリケーション クラスを宣言します。

SignedUnsigned.cpp
   これは、アプリケーション クラス CSignedUnsignedApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\SignedUnsigned.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル SignedUnsigned.rc に含まれていま
   す。

res\SignedUnsigned.rc2
...
SignedUnsignedDlg.h, SignedUnsignedDlg.cpp - ダイアログ
   これらのファイルは CSignedUnsignedDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な SignedUnsigned.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   SignedUnsigned.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
