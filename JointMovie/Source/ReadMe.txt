================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: JointMovie プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した JointMovie には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには JointMovie アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
JointMovie.h
   ...
   CJointMovieApp アプリケーション クラスを宣言します。

JointMovie.cpp
   これは、アプリケーション クラス CJointMovieApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\JointMovie.ico
   ...
   アイコンはメイン リソース ファイル JointMovie.rc に含まれていま
   す。
...
JointMovieDlg.h, JointMovieDlg.cpp - ダイアログ
   これらのファイルは CJointMovieDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な JointMovie.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   JointMovie.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
