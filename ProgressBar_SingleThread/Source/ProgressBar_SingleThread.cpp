...
// ProgressBar_SingleThread.cpp : アプリケーションのクラス動作を定義します。
//
...
// CProgressBar_SingleThreadApp コンストラクション
...
// 唯一の CProgressBar_SingleThreadApp オブジェクトです。

CProgressBar_SingleThreadApp theApp;


// CProgressBar_SingleThreadApp 初期化
