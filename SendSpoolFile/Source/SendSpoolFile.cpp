// SendSpoolFile.cpp : アプリケーションのクラス動作を定義します。
//
...
// CSendSpoolFileApp コンストラクション

CSendSpoolFileApp::CSendSpoolFileApp()
{
...
// 唯一の CSendSpoolFileApp オブジェクトです。

CSendSpoolFileApp theApp;


// CSendSpoolFileApp 初期化
