================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Launcher2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Launcher2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Launcher2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Launcher2.h
   ...
   CLauncher2App アプリケーション クラスを宣言します。

Launcher2.cpp
   これは、アプリケーション クラス CLauncher2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Launcher2.ico
   ...
   アイコンはメイン リソース ファイル Launcher2.rc に含まれていま
   す。
...
Launcher2Dlg.h, Launcher2Dlg.cpp - ダイアログ
   これらのファイルは CLauncher2Dlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Launcher2.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Launcher2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
