================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: SplitPathOwn プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した SplitPathOwn には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには SplitPathOwn アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

SplitPathOwn.vcxproj
...
SplitPathOwn.h
   ...
   CSplitPathOwnApp アプリケーション クラスを宣言します。

SplitPathOwn.cpp
   これは、アプリケーション クラス CSplitPathOwnApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\SplitPathOwn.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル SplitPathOwn.rc に含まれていま
   す。

res\SplitPathOwn.rc2
...
SplitPathOwnDlg.h, SplitPathOwnDlg.cpp - ダイアログ
   これらのファイルは CSplitPathOwnDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な SplitPathOwn.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   SplitPathOwn.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
