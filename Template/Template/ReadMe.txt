================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Template プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Template には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Template アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Template.h
   ...
   CTemplateApp アプリケーション クラスを宣言します。

Template.cpp
   これは、アプリケーション クラス CTemplateApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Template.ico
   ...
   アイコンはメイン リソース ファイル Template.rc に含まれていま
   す。
...
TemplateDlg.h, TemplateDlg.cpp - ダイアログ
   これらのファイルは CTemplateDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Template.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Template.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
