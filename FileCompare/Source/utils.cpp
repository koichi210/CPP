...
BOOL CMyCompareFile::CompareBinary(int *pSize)
{
	BOOL bReturn = Open();
	
	if ( bReturn )
	{
		bReturn = IsSameFile(pSize);
	}
...
BOOL CMyCompareFile::CompareBinary(CString strFile1, CString strFile2, int *pSize)
{
	m_file1 = strFile1;
	m_file2 = strFile2;

	return CompareBinary(pSize);
}
...
BOOL CMyCompareFile::IsSameFile(int *pSize)
{
	BOOL bReturn = FALSE;
