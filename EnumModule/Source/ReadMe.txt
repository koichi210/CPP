================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: EnumModule プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した EnumModule には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには EnumModule アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
EnumModule.h
   ...
   CEnumModuleApp アプリケーション クラスを宣言します。

EnumModule.cpp
   これは、アプリケーション クラス CEnumModuleApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\EnumModule.ico
   ...
   アイコンはメイン リソース ファイル EnumModule.rc に含まれていま
   す。
...
EnumModuleDlg.h, EnumModuleDlg.cpp - ダイアログ
   これらのファイルは CEnumModuleDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な EnumModule.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   EnumModule.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
