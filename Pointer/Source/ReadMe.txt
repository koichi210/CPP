================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Pointer プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Pointer には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Pointer アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Pointer.h
   ...
   CPointerApp アプリケーション クラスを宣言します。

Pointer.cpp
   これは、アプリケーション クラス CPointerApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Pointer.ico
   ...
   アイコンはメイン リソース ファイル Pointer.rc に含まれていま
   す。
...
PointerDlg.h, PointerDlg.cpp - ダイアログ
   これらのファイルは CPointerDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Pointer.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Pointer.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
