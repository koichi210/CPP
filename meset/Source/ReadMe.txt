================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: meset プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した meset には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには meset アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
meset.h
   ...
   CmesetApp アプリケーション クラスを宣言します。

meset.cpp
   これは、アプリケーション クラス CmesetApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\meset.ico
   ...
   アイコンはメイン リソース ファイル meset.rc に含まれていま
   す。
...
mesetDlg.h, mesetDlg.cpp - ダイアログ
   これらのファイルは CmesetDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な meset.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   meset.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
